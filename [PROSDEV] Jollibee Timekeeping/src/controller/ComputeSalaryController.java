...
public class ComputeSalaryController implements Listen, PanelChanger {
    ...
    private void removeNoSalary() throws SQLException {
        ...
        while (iterator.hasNext()) {
            emp = iterator.next();
            attendance = AttendanceModel.getUnpaidEmp(emp.getEmpID());
    ...
    private void refreshEmployeeList() {
        ...
        if (!employees.isEmpty()) {
            ...
            for (int i = 0; i < len; i++) {
                ...
                ComputeSalaryEmployeePanel panel = new ComputeSalaryEmployeePanel(e.getLname() + ", " + e.getFname() + " " + e.getMname(), String.valueOf(e.getIdNumber()), "Project Name", employees.get(i).getTotalSalary() + "");
