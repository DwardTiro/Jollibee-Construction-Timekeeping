...
public class ManageEmployeeController implements Listen, PanelChanger {
    ...
    private void refreshEmployeeList(){
        ...
        layout.setRows(len);
        mainFrame.getManageEmployeePanel().setPreferredSize(new Dimension(mainFrame.getManageEmployeePanel().getPreferredSize().width, MainFrame.getSPACE_ABOVE() + mainFrame.getLabelManageEmployee().getPreferredSize().height + mainFrame.getLabelManageEmployeeAttendance().getPreferredSize().height + ManageEmployeeAttendancePanel.PANEL_HEIGHT * (len) + mainFrame.getButtonManageEmployeeSubmit().getPreferredSize().height));
